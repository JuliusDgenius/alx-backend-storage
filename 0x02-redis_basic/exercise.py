#!/usr/bin/env python3
"""
Module defines the Cache class.
"""
...
def call_history(method: Callable) -> Callable:
    """
    Records the call details of a method call in a Cache class.
    """
    @wraps(method)
    def invoker(self, *args, **kwargs) -> Any:
        """
        Stores a method's inputs and output and returns the output.
        """
...
def replay(fn: Callable) -> None:
    """
    Outputs the call history of a Cache class' method.
    """
